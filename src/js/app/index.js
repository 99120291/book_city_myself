require(["jquery", "swiper", "bscroll", "render", "text!bookTb", "text!bookLr", "GetSlideDirection", "storage"],
    function($, swiper, bscroll, render, bookTb, bookLr, GetSlideDirection, storage) {
        ...
        function isLogin() {
            ...
            if (!username) {
                location.href = '../js/page/tpl/login.html';
            } else {
                $.ajax({
                    url: "/isLogin",
                    type: "post",
                    ...
                    success: function(res) {
                        if (res.code == 1 && res.result) {
                            window.location.href = "../../js/page/tpl/myself.html"
